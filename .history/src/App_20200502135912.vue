  ...
  <div id="q-app" class="row full-width vh100">
    <div class="col vh100">
      <div class="column">
        <div class="col-1 row">
          <div class="col">
            <q-input dense filled v-model="sDockerHubSearchText" label="Search text..." @keyup="fnDebounceSearchResultsUpdate"/>
          </div>
          <div class="col-2">
    ...
    return new Promise((fnSuccess, fnFail) => {
      ...
      axios
        ...
        .then(function (response) {
          fnSuccess(Array.from(response.data.summaries));
        })
...
export default {
  ...
  methods: {
    ...
    async fnUpdateDockerHubList()
    {
      ...
      console.log(oThis.aDockerHubItems);
    }
  },
